...
from sklearn.ensemble import GradientBoostingClassifier  # Change the model here
...
# Create a GradientBoostingClassifier (replace RandomForestClassifier with GradientBoostingClassifier)
