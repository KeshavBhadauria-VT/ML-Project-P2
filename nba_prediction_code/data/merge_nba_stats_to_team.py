...
# Assuming column names are known and correctly ordered
# Add prefix to season columns for home and away teams
# season_df.columns = ["HOME_" + col if col != "team" and col != "year" else col for col in season_df.columns]
# season_df.columns = ["AWAY_" + col if col == "team" or col == "year" else col for col in season_df.columns]
